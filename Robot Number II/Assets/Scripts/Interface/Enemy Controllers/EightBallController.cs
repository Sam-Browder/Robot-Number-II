...
public class EightBallController : MonoBehaviour, ICharacter {
	...
	void NoGround(){
		Vector3 currentPos = new Vector3(this.transform.position.x+1f*this.direction,this.transform.position.y, this.transform.position.z);
		Vector3 endPos = new Vector3 (currentPos.x, currentPos.y-5f, currentPos.z);
		Debug.DrawLine(currentPos, endPos,Color.green);
