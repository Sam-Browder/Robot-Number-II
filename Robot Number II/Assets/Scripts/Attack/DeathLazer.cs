...
public class DeathLazer : IAbility {
	
	private string ability = "DeathLazer";
	...
	public DeathLazer(float EMDamage, float ThermalDamage, float KineticDamage, float ExplosiveDamage, float cd){
